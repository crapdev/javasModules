...
public class EmployeeService {
    ...
    public PerformanceReport generarReporteDesempeno(Employee employee) {
        ...
        var promedio = employee.getPromedioDesempeno();
        var feedback = promedio >= PROMEDIO_PARA_PROMOCION ? "Excelente desempeño" : "Debe continuar mejorando";

        return new PerformanceReport( employee.getId(), promedio, feedback);
    }
    
    
    //Aqui se implementa patter matching for intanceof con la sintaxis moderna
    // De forma que nos ahorramos lineas de codigo sin tener que hacerlo con un casting manual obligatorio
    // y nos ahorramos el Developer developer = (Developer) employee;
